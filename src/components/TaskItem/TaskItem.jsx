...
import { Badge, Card, Select, Space, Tag } from "antd";
...
const TaskItem = ({ tasks }) => {
  ...
  return (
    <>
          ...
          tasks.map((task) => (
            ...
            >
              <div className="task-item-card ">
                <div className="infor-task-cover mb-2">
                ...
                <div className="d-flex align-items-center justify-content-between mt-3">
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <span style={{ fontSize: "11px" }}>
                      ...
                      <Tag color={task?.completed ? "green":"red"}>{task?.completed ? "Đã hoàn thành":"Chưa hoàn thành"}</Tag>
                  </div>
                  <div className="d-flex align-items-center gap-1">
      ...
      {editingTask && (
        <UpdateTask
          refetch1={refetchTasksQuery}
          refetch2={refetchStatistics}
          isOpen={editingTask}
      ...
      {isShowDelete && (
        <ConfirmModal
          message={"Bạn có chắc chắn xóa nhiệm vụ"}
          name={name}
